        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <section class="p-2 md:p-10">
                    <form method="POST" action="{{ url('admin/store') }}" class="grid grid-cols-1 gap-2 font-bold" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="flex justify-center">
                            <button type="submit" class="px-5 py-3 bg-slate-400 text-white shadow-xl">Create</button>
                        </div>
                    </form>
                    <output></output>
                </section>
