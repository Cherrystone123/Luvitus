                    ...
                    <div class="-me-2 flex items-center sm:hidden">
                        ...
                        <div id="mobile-menu" class="z-10 w-full h-full bg-slate-300 font-bold absolute hidden sm:hidden" style="left: 0; top: 0;">
                            <div class="pt-2 pb-3 space-y-1">
                                ...
                                <a href="{{ url('/') }}" class="block w-full ps-3 pe-4 py-2 border-l-4 border-indigo-400 text-start text-base font-medium text-indigo-700 bg-indigo-50 focus:outline-none focus:text-indigo-800 focus:bg-indigo-100 focus:border-indigo-700 transition duration-150 ease-in-out">Home</a>
                                <a href="{{ url('guest/category') }}" class="block w-full ps-3 pe-4 py-2 border-l-4 border-transparent text-start text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:text-gray-800 focus:bg-gray-50 focus:border-gray-300 transition duration-150 ease-in-out">Category</a>
            ...
            <div class="py-12">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                        <section class="md:p-10 px-5 py-3 grid grid-cols-1 md:grid-cols-4 gap-64">
                                ...
                                <div class="flip-card">
                                    <div class="flip-card-inner shadow-xl rounded-lg">
                                        ...
                                        <div class="flip-card-back rounded-lg bg-slate-300 overflow-hidden">
                                            ...
                                            <a href="{{url('guest/category/'.$post->category)}}">{{$post -> category}}</a>
                                            <div class="p-1 flex justify-center ">
                                                <a href="{{ url('guest/posts/'.$post->id) }}" class="bg-slate-200 upparcase font-bold p-1">Buy</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
